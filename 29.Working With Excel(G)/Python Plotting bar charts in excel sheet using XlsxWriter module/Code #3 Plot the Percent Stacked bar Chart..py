...
'''For plotting the Percent Stacked Bar chart on an excel sheet, use add_chart() method with type ‘bar’ and subtype 
‘percent_stacked’ keyword argument of a workbook object.'''
