...
# Title and Icon
pygame.display.set_caption("TERNARY SEARCH VISUALISER")
...
def draw():
    ...
    txt = fnt.render("SEARCH: PRESS 'ENTER'",1, (0, 0, 0))
    ...
    txt2 = fnt1.render("ENTER NUMBER TO SEARCH:" + str(key), 1, (0, 0, 0))
    ...
    if foundkey == 1:
        ...
        text4 = bigfont.render("Key Not Found. Press N to Reset Key", 1, (0, 0, 0))
