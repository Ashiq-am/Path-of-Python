...
class AutoScrollbar(Scrollbar):
    ...
    horiscrollbar = AutoScrollbar(root,orient=HORIZONTAL)
    ...
    for i in range(1, rows):
        for j in range(1, 9):
            button = Button(frame, padx=8, pady=8,text="[%d,%d]" % (i, j))
